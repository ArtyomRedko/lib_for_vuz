...
let pageImage = document.getElementById('page');
...
displayBook.addEventListener("click", function (){
  book = new Book(globalLink);
  book.displayPage();
  book.maxPage = maxPageG;
});
...
btnNext.addEventListener("click", function (){
  ...
  btnPrevious.removeAttribute("hidden", "hidden");
  book.displayPage();
});

btnPrevious.addEventListener("click", function (){
  if(!book.previousPage()){
    btnPrevious.setAttribute("hidden", "hidden");
  }
  btnNext.removeAttribute("hidden", "hidden");
  book.displayPage();
});
